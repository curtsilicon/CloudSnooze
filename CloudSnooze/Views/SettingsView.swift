...
struct SettingsView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .alert("Disconnect Account?", isPresented: $showDisconnectAlert) {
                ...
                Text("This will remove your stored credentials from the device. You will need to reconnect to use CloudSnooze.")
            }
    ...
    private var accountSection: some View {
        Section {
            ...
            Text("Instances are discovered across all AWS regions automatically. Credentials are stored in the iOS Keychain.")
        }
    }
    ...
    private var aboutSection: some View {
        Section("About") {
            LabeledContent("App", value: "CloudSnooze")
    ...
    private func rescan() async {
        ...
        await MainActor.run { rescanComplete = false }
    }
